...
pth_comp = sys.argv[1]
if not(sys.argv[1]):
    path_token =r'/home/negrete/test_gee/token/'
...
if not(sys.argv[3]):
    path_prod_id = r'/mnt/c/Users/DiazGustavoV/Documents/Pers_Proj/Sentinel_2_getter/Output/'
...
output_path = r'/home/negrete/test_gee/token/output/'

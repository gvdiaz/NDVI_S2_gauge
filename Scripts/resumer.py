...
def main(config_path, conf_dict, development, verbose2conf):
    ...
    df = mfc.add_statistics(df, dict2df, conf_dict['FOLDERS']['output'], verbose2conf)
    ...
    mfc.delete_file(config_path, verbose2conf)
...
if __name__ == "__main__":
    ...
    try:
        exit_code = main(config_path, conf_dict, development, verbose2conf)

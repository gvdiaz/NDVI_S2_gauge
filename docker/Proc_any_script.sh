...
# objetivo script:
# Pruebas programadas para probar procesador con módulos progamados en snappy 9 python3.6 y correrlos en snappy 11 y python 3.10.
...
PATH_SNAPPY="${PATH_REPO}/docker/snappy_11_dock/"
PROC_CONF="${PATH_REPO}/utils/CONF_PROC.INI"
PATH_OUTPUT="${PATH_REPO}/output/"

# SCRIPTS BASH
PYTHON_LAUNCHER="python_310_launcher.sh"
